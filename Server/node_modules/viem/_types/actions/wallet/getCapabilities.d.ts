...
export type GetCapabilitiesReturnType<chainId extends number | undefined = undefined> = Prettify<chainId extends number ? WalletCapabilities : WalletCapabilitiesRecord<WalletCapabilities, number>>;
