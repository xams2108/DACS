...
class ClientScopedStorage {
    ...
    async getGuestSessionId() {
        return this.getItem((0, settings_js_1.GUEST_SESSION_LOCAL_STORAGE_NAME)(this.key));
    }
    /**
     * @internal
     */
    async saveGuestSessionId(sessionId) {
        await this.setItem((0, settings_js_1.GUEST_SESSION_LOCAL_STORAGE_NAME)(this.key), sessionId);
    }
}
