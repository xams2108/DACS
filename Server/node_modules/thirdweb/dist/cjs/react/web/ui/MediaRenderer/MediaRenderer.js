...
exports.MediaRenderer = (() => (0, react_1.forwardRef)(function Media_Renderer({ src, poster, alt, gatewayUrl, requireInteraction = false, width = "300px", height = "300px", style, mimeType, client, controls, className, }, ref) {
    ...
    if (mediaInfo.mimeType) {
        ...
        if (mediaInfo.mimeType.startsWith("text/html")) {
            return ((0, jsx_runtime_1.jsx)(exports.IframePlayer, { style: mergedStyle, src: mediaInfo.url, poster: possiblePosterSrc.url, ref: ref, requireInteraction: requireInteraction, className: className, alt: alt }));
        }
        // 3d model
    ...
    return ((0, jsx_runtime_1.jsx)(exports.LinkPlayer, { style: mergedStyle, src: mediaInfo.url, alt: alt, ref: ref, className: className }));
}))();
...
const ImageRenderer = /* @__PURE__ */ (() => (0, react_1.forwardRef)(function Image_Renderer(props, ref) {
    ...
    if (error) {
        return ((0, jsx_runtime_1.jsx)(exports.LinkPlayer, { style: style, src: src, alt: alt, ref: ref, className: className }));
    }
