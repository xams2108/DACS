...
export type PrepareContractCallOptions<TAbi extends Abi = [], TMethod extends AbiFunction | string | ((contract: ThirdwebContract<TAbi>) => Promise<AbiFunction>) = TAbi extends {
    length: 0;
} ? AbiFunction | string : ExtractAbiFunctionNames<TAbi>, TPreparedMethod extends PreparedMethod<ParseMethod<TAbi, TMethod>> = PreparedMethod<ParseMethod<TAbi, TMethod>>> = BaseTransactionOptions<Omit<TransactionRequest, "from" | "to" | "data" | "value" | "accessList" | "gas" | "gasPrice" | "maxFeePerGas" | "maxPriorityFeePerGas" | "nonce" | "authorizationList"> & {
