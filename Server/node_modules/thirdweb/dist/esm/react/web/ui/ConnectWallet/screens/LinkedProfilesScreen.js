...
export function LinkedProfilesScreen(props) {
    ...
    return (_jsxs(Container, { style: {
            minHeight: "300px",
        }, children: [_jsx(Container, { p: "lg", children: _jsx(ModalHeader, { title: props.locale.manageWallet.linkedProfiles, onBack: props.onBack }) }), _jsx(Line, {}), _jsxs(Container, { scrollY: true, style: {
                    height: "300px",
                                ...
                                .map((profile) => (_jsx(LinkedProfile, { enableUnlinking: connectedProfiles.length > 1, profile: profile, client: props.client }, `${JSON.stringify(profile)}`)))] }), _jsx(Spacer, { y: "md" })] })] }));
}
        ...
        : true, children: [socialProfiles?.some((p) => p.avatar) ? (_jsx(Img, { src: socialProfiles?.find((p) => p.avatar)?.avatar, width: iconSize.lg, height: iconSize.lg, loading: "eager", client: client, style: {
                    ...
                    flexGrow: 1,
                            ...
                            gap: "8px",
                                ...
                                profile.details.address && (_jsx(Text, { color: "secondaryText", size: "sm", children: shortenAddress(profile.details.address, 4) })), enableUnlinking && (_jsx(IconButton, { autoFocus: true, type: "button", "aria-label": "Unlink", onClick: () => unlinkProfileMutation({
                                    client,
                                    profileToUnlink: profile,
                                }), style: {
                                    pointerEvents: "auto",
                                }, disabled: isPending, children: _jsx(Cross2Icon, { width: iconSize.md, height: iconSize.md, style: {
                                        color: "inherit",
                                    } }) }))] })] })] }));
}
