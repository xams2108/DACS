...
const WalletSelectorInner = (props) => {
    ...
    const connectAWallet = (_jsx(WalletTypeRowButton, { client: props.client, icon: OutlineWalletIcon, disabled: props.meta.requireApproval && !approvedTOS, onClick: () => {
