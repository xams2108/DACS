 ...
 * @extension ERC1271
 */
export type CheckContractWalletSignTypedDataOptions<typedData extends ox__TypedData.TypedData | Record<string, unknown>, primaryType extends keyof typedData | "EIP712Domain" = keyof typedData> = {
 ...
 */
export declare function checkContractWalletSignedTypedData<typedData extends ox__TypedData.TypedData | Record<string, unknown>, primaryType extends keyof typedData | "EIP712Domain" = keyof typedData>(options: CheckContractWalletSignTypedDataOptions<typedData, primaryType>): Promise<boolean>;
