...
import type { Chain, ChainMetadata, ChainOptions, ChainService, LegacyChain } from "./types.js";
/**
 ...
 * @chain
 */
export declare function getChainServices(chain: Chain): Promise<ChainService[]>;
/**
