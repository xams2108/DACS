...
export const ReceiveScreen = (props) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Header, { theme: theme, onClose: onClose, onBack: onBack, containerType: containerType, title: "Receive Funds" }), _jsxs(View, { style: styles.container, children: [_jsx(WalletImage, { theme: theme, wallet: wallet, size: 80, client: client }), _jsx(Spacer, { size: "lg" }), _jsx(View, { style: [
