    ...
    return (_jsxs(Container, { flex: "column", gap: "md", style: {
            position: "relative",
                ...
                (inputMode === "phone" ? (_jsx(InputSelectionUI, { format: "phone", type: type, onSelect: (value) => {
                        ...
                        return undefined;
                    }, disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, submitButtonText: locale.submitEmail, defaultSmsCountryCode: wallet.getConfig()?.auth?.defaultSmsCountryCode })) : (_jsx(WalletTypeRowButton, { client: props.client, icon: PhoneIcon, onClick: () => {
