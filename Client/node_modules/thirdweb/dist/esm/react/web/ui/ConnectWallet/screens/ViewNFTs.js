...
export function ViewNFTsContent(props) {
    ...
    const filteredNFTs = props.supportedNFTs?.[activeChain.id]
        ...
        : nftQuery.data;
    return (_jsxs(_Fragment, { children: [nftQuery.error ? (_jsx(Container, { center: "both", py: "lg", children: _jsx(Text, { size: "sm", color: "secondaryText", center: true, children: "Error loading NFTs" }) })) : nftQuery.data?.length === 0 && !nftQuery.isLoading ? (_jsx(Container, { center: "both", py: "lg", children: _jsx(Text, { size: "sm", color: "secondaryText", center: true, children: "No NFTs found on this chain" }) })) : (_jsx(Container, { style: {
                    display: "grid",
                    gridTemplateColumns: "1fr 1fr",
                    gap: "12px",
                }, children: nftQuery.isLoading || !filteredNFTs ? (_jsxs(_Fragment, { children: [_jsx(Skeleton, { height: "150px", width: "150px" }), _jsx(Skeleton, { height: "150px", width: "150px" }), _jsx(Skeleton, { height: "150px", width: "150px" })] })) : (filteredNFTs.map((nft) => (_jsx(NftCard, { ...nft, client: props.client, chain: nft.chain, theme: props.theme }, `${nft.chain.id}:${nft.address}:${nft.id}`)))) })), _jsx(Spacer, { y: "lg" })] }));
}
    ...
    const content = (_jsxs("div", { style: {
            ...
            alignItems: "center",
                    ...
                    background: theme === "light" ? "rgba(0, 0, 0, 0.10)" : "rgba(0, 0, 0, 0.20)",
                            ...
                            width: "20px",
                            height: "20px",
                        }, src: props.chain.icon.url }))] }), _jsx(Text, { size: "xs", color: "primaryText", style: {
                    fontWeight: 600,
                    textAlign: "center",
                    maxLines: 2,
