...
export function TransactionModeScreen(props) {
    ...
    return (_jsxs(Container, { px: "lg", children: [_jsx(Spacer, { y: "lg" }), _jsx(ModalHeader, { title: metadata?.name || "Transaction" }), _jsx(Spacer, { y: "lg" }), _jsxs(Container, { children: [metadata?.image ? (_jsx(Img, { client: client, src: metadata?.image, style: {
                        ...
                        } })) : activeAccount ? (_jsxs(Container, { flex: "column", gap: "sm", children: [insufficientFunds && (_jsxs("div", { children: [_jsx(Text, { color: "danger", size: "xs", center: true, multiline: true, children: "Insufficient Funds" }), _jsx(Text, { size: "xs", center: true, multiline: true, children: "Select another token or pay with a debit card." })] })), _jsxs(Container, { flex: "row", style: {
