...
function LinkProfileScreen(props) {
    ...
    if (wallet.id === "inApp") {
        return ((0, jsx_runtime_1.jsx)(react_1.Suspense, { fallback: (0, jsx_runtime_1.jsx)(LoadingScreen_js_1.LoadingScreen, {}), children: (0, jsx_runtime_1.jsx)(InAppWalletConnectUI, { walletConnect: props.walletConnect, wallet: wallet, done: () => {
                    setTimeout(() => {
    ...
    if ((0, is_ecosystem_wallet_js_1.isEcosystemWallet)(wallet)) {
        return ((0, jsx_runtime_1.jsx)(react_1.Suspense, { fallback: (0, jsx_runtime_1.jsx)(LoadingScreen_js_1.LoadingScreen, {}), children: (0, jsx_runtime_1.jsx)(EcosystemWalletConnectUI_js_1.default, { wallet: wallet, done: () => {
                    setTimeout(() => {
                        queryClient.invalidateQueries({ queryKey: ["profiles"] });
                    }, 500);
                    props.onBack();
