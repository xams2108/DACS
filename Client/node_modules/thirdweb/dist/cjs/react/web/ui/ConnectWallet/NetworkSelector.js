...
const NetworkTabContent = (props) => {
    ...
    return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { scrollY: true, animate: "fadein", style: {
            ...
            return ((0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [idx !== 0 && (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(exports.SectionLabel, { children: section.label }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xs" }), (0, jsx_runtime_1.jsx)(exports.NetworkList, { chains: section.chains, onSwitch: props.onSwitch, renderChain: props.renderChain, close: props.close, client: props.client, connectLocale: props.connectLocale })] }, section.label));
        })) }));
};
/**
...
exports.ChainButton = (0, react_1.memo)(function ChainButton(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(provider_js_1.ChainProvider, { chain: chain, children: (0, jsx_runtime_1.jsxs)(exports.NetworkButton, { "data-active": activeChain?.id === chain.id, onClick: props.onClick, children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: {
                        ...
                        flexShrink: 0,
                        alignItems: "center",
                    }, children: [(0, jsx_runtime_1.jsx)(icon_js_1.ChainIcon, { client: props.client, loadingComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: `${index_js_1.iconSize.lg}px`, height: `${index_js_1.iconSize.lg}px` }), fallbackComponent: (0, jsx_runtime_1.jsx)("img", { src: fallbackChainIcon_js_1.fallbackChainIcon, alt: "", style: {
                                    width: `${index_js_1.iconSize.lg}px`,
                                    height: `${index_js_1.iconSize.lg}px`,
                                } }), style: {
                                width: `${index_js_1.iconSize.lg}px`,
                                height: `${index_js_1.iconSize.lg}px`,
                            }, loading: "lazy" }), activeChain?.id === chain.id && ((0, jsx_runtime_1.jsx)(ChainActiveDot_js_1.ChainActiveDot, { className: "tw-chain-active-dot-button-network-selector" }))] }), confirming || switchingFailed ? ((0, jsx_runtime_1.jsxs)("div", { style: {
                        display: "flex",
                        flexDirection: "column",
                        gap: index_js_1.spacing.xs,
                    }, children: [(0, jsx_runtime_1.jsx)(name_js_1.ChainName, { loadingComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: "150px", height: "20px" }) }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { animate: "fadein", flex: "row", gap: "xxs", center: "y", children: [confirming && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", color: "accentText", children: locale.switchingNetwork }), (0, jsx_runtime_1.jsx)(Spinner_js_1.Spinner, { size: "xs", color: "accentText" })] })), switchingFailed && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { animate: "fadein", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", color: "danger", children: locale.networkSelector.failedToSwitch }) }))] })] })) : ((0, jsx_runtime_1.jsx)(name_js_1.ChainName, { loadingComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: "150px", height: "20px" }), className: "tw-chain-icon-none-confirming" }))] }) }));
});
/**
 * @internal Exported for tests
 */
