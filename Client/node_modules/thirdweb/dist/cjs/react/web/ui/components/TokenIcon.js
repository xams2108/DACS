...
function TokenIcon(props) {
    ...
    return tokenImage ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: tokenImage, width: index_js_1.iconSize[props.size], height: index_js_1.iconSize[props.size], fallbackImage: walletIcon_js_1.genericTokenIcon, client: props.client })) : ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { center: "both", style: { width: index_js_1.iconSize[props.size], height: index_js_1.iconSize[props.size] }, color: "secondaryText", children: (0, jsx_runtime_1.jsx)(CoinsIcon_js_1.CoinsIcon, { size: index_js_1.iconSize[props.size] }) }));
}
