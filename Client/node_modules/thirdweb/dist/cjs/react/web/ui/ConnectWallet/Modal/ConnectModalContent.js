...
const ConnectModalContent = (props) => {
    ...
    const signatureScreen = ((0, jsx_runtime_1.jsx)(SignatureScreen_js_1.SignatureScreen, { onDone: onClose, onClose: onClose, modalSize: props.size, termsOfServiceUrl: props.meta.termsOfServiceUrl, privacyPolicyUrl: props.meta.privacyPolicyUrl, auth: props.auth, client: props.client, connectLocale: props.connectLocale }));
