...
function WalletEntryButton(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(exports.WalletButtonEl, { type: "button", onClick: selectWallet, "data-active": props.isActive, children: [iconOverride ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { client: props.client, src: iconOverride, alt: nameOverride, width: `${index_js_1.iconSize.xl}`, height: `${index_js_1.iconSize.xl}` })) : ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { id: walletId, size: index_js_1.iconSize.xl, client: props.client })), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "xxs", expand: true, children: [nameOverride ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", weight: 600, children: nameOverride })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: "100px", height: index_js_1.fontSize.md })), props.badge ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", children: props.badge })) : isRecommended ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", children: props.connectLocale.recommended })) : isInstalled ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", children: props.connectLocale.installed })) : null] })] }));
}
