...
function TransactionModeScreen(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: metadata?.name || "Transaction" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { children: [metadata?.image ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { client: client, src: metadata?.image, style: {
                        ...
                        } })) : activeAccount ? ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "sm", children: [insufficientFunds && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "danger", size: "xs", center: true, multiline: true, children: "Insufficient Funds" }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", center: true, multiline: true, children: "Select another token or pay with a debit card." })] })), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", style: {
