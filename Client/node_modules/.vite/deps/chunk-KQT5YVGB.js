...
import {
  getCurrencyMetadata
} from "./chunk-SQ5OR4US.js";
import {
  detectMethod
} from "./chunk-MUHOVHES.js";
import {
  readContract
...
async function getNFTAsset(options) {
  ...
  switch (true) {
    case erc721: {
      const { getNFT } = await import("./getNFT-UDD27GX6.js");
      return getNFT(options);
    }
    case erc1155: {
      const { getNFT } = await import("./getNFT-AUDRDVXZ.js");
      return getNFT(options);
    }
    default: {
...
//# sourceMappingURL=chunk-KQT5YVGB.js.map
